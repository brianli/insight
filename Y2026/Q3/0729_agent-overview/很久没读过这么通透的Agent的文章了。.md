---
title: 很久没读过这么通透的Agent的文章了。
source: https://mp.weixin.qq.com/s/lSbhHK0T5NUYuhwhgyK_LQ
author:
  - "[[阿颖]]"
published:
created: 2026-07-29
...
tags:
  ...
  - "#agent/evomap"
---
> [!warning] 这篇文章看完最重要的收获为：
> 1. 即使使用相同的模型，若使用一个 Agent，准确率只有 26%，而使用主-SubAgent 模式下也只有 38%，而使用 EvoX 蜂群模式下可以高达 71%
> 2. 在 Main-SubAgent 模式下，刚开始是做对了，但是在大模型汇总的时候会出错。因此能用确定性的程序时使用确定性的程序来做，可以减少不必要的损耗
> 3. 在 EvoX 蜂群模式下，Agent 可以进行自组织

阿颖 AI产品阿颖 *2026年7月25日 16:27*
...
梁文锋也讲过，下一代 AI 一个非常重要的能力，就是<mark style="background: #FFF3A3A6;">自主持续学习</mark>。当Agent 能够持续学习跨过自我迭代的奇点，下一代通用智能就会加速
...
<mark style="background: #D2B3FFA6;">主 Agent 负责理解目标、拆解任务、分配工作。Sub-Agent 各自执行，最后把结果交回主 Agent，由它汇总</mark>。
...
最后的差距非常夸张。<mark style="background: #FFB86CA6;">单 Agent 的正确率是 26.29%。Sub-Agent 模式是 38.54%。EvoX 蜂群达到了 70.69% 到 70.87%</mark>。

![Image](https://mmbiz.qpic.cn/mmbiz_png/iagroyM7YaBn1icYmVsaD0E0Uoe4jklPXXxricQ64nmflibbN0gPtqdUUHFqWMFzfWNdUWB1f1d5iad8ToYlllOVk29oc5DRlxfFWkLibWlfKzibuM/640?wx_fmt=png&from=appmsg#imgIndex=0)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/iagroyM7YaBkspZYPddLKebVgaNwXEdtfweMykiaxHKDAoaNJtooJ0sS1shhlbLrwUOyic9alcvJIzezfTQYXMJ8L5v6OicclYjIyFtCBTXtstA/640?wx_fmt=png&from=appmsg#imgIndex=1)
...
![Image](https://mmbiz.qpic.cn/sz_mmbiz_png/iagroyM7YaBmF8bfHmTO5vB7KqOl0cpI1m84UtokTzIhHKuGPTnqoBgnPfmvRGELPbfsFubPBGOe6WKwfV4BAaic0tI3Y9ABAuicxIalSB8eT8/640?wx_fmt=png&from=appmsg#imgIndex=2)
...
![Image](https://mmbiz.qpic.cn/mmbiz_jpg/iagroyM7YaBm2hW48ltK8ExHm8C90aQia1mhMibSWDaYYMdcyiaHF1Zic2f7LNUhnqJicBlkVNGEXmc2l5CAS2T2Efj7prIopk1ZjZYdUQavKDcPg/640?wx_fmt=jpeg&from=appmsg#imgIndex=3)